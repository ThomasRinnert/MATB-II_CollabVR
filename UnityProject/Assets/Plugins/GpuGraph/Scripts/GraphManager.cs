...
public class GraphManager : MonoBehaviour
{
    ...
    public class GPUGraphData
    {
        ...
        public void ResetDefault()
        {
            ...
            MinValue = (Range != null) ? Range[0] : float.MaxValue;
            MaxValue = (Range != null) ? Range[1] : float.MinValue;
            ...
            if (ParentUI)
            {
                ...
                if(CanvasUI != null)
                {
                    if (MaxUI == null)
                    {
                        ...
                        MaxTransform.localRotation = Quaternion.identity;
                    }
                    ...
                    if (AvgUI == null)
                    {
                        ...
                        AvgTransform.localRotation = Quaternion.identity;
                    }
                    ...
                    if (MinUI == null)
                    {
                        ...
                        MinTransform.localRotation = Quaternion.identity;
                    }
        ...
        public void Render(Material graphMaterial)
        {
            ...
            for (int i = 1; i < DataPairs.Count; ++i)
            {
                ...
                DrawLine(new Vector3(pPos.x, pPos.y + 0.011f, pPos.z), new Vector3(cPos.x, cPos.y + 0.011f, cPos.z), false);
                DrawLine(new Vector3(pPos.x, pPos.y + 0.005f, pPos.z), new Vector3(cPos.x, cPos.y + 0.005f, cPos.z), false);
                DrawLine(new Vector3(pPos.x, pPos.y - 0.011f, pPos.z), new Vector3(cPos.x, cPos.y - 0.011f, cPos.z), false);
                DrawLine(new Vector3(pPos.x, pPos.y - 0.005f, pPos.z), new Vector3(cPos.x, cPos.y - 0.005f, cPos.z), false);
            }
